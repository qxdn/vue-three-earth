<template>
  ...
  <div class="login-plane">
    <div class="links-container">
      ...
      <div id="userName">@qxdn</div>

      <div id="links">
        <Item title="Github" url="https://github.com/qxdn" className="fa-brands fa-github" />
        <Item title="Blog" url="https://qianxu.run" className="fa-solid fa-blog" />
        <Item title="镜像站" url="https://blog.qxdn.fun" className="fa-solid fa-blog" />
        <Item title="云盘" url="https://pan.qianxu.run" className="fa-solid fa-hard-drive" />
        <Item title="音乐阁" url="https://qianxu.run/music" className="fa-solid fa-music" />
        <Item title="Ciallo" url="https://ciallo.qianxu.run" />
        <Item title="监控" url="https://status.qianxu.run" className="fa-solid fa-tv" />
      </div>
    </div>
  </div>
</template>
...
import { createEarthWithAtmosphere } from './utils/planets'
...
export default defineComponent({
  setup() {
    ...
    const initSphereModal = () => {
      sphere = createEarthWithAtmosphere(50, 64, 32)
    }
